...
client: game/bobjecttypes.o io/gameevent.o io/eventmeta.o curseme/menudriver.o curseme/cursesmenudriver.o curseme/renderer.o curseme/hotkeymenudriver.o ui/menu.o util/log.o client.o io/remotegameclient.o io/localbackend.o io/remotefrontend.o world/clientworld.o world/worldbase.o io/clientbase.o io/eventqueue.o world/clientarea.o world/areabase.o net/tcpbuffer.o net/netaddress.o ui/prompt.o ui/titlebox.o net/tcpsocket.o net/socket.o game/containerbase.o world/tilebase.o game/observable.o world/clienttile.o util/stringhelper.o util/streambuffering.o $(CURSES_OBJS) $(RESOURCE_OBJS) $(BASIC_UTIL_OBJS) resource/visualization.o
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@
