...
raw_editor: tools/raw_editor_ncurses/main.o resource/raw.o resource/protobobject.o game/bobject.o game/complexbobject.o game/atomicbobject.o game/compositebobject.o util/filesystem.o tools/raw_editor_ncurses/common.o tools/raw_editor_ncurses/complex.o tools/raw_editor_ncurses/composite.o game/bobjectmanager.o game/containerbase.o game/containerbobject.o game/observable.o util/uniquestringpair.o util/sectioneddata.o ui/menu.o curseme/menudriver.o ui/titlebox.o ui/prompt.o curseme/cursesmenudriver.o curseme/hotkeymenudriver.o util/serialize.o game/combat.o $(CURSES_OBJS) $(RESOURCE_OBJS) $(BASIC_UTIL_OBJS) $(SAVE_OBJS)
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@
...
worldtest: io/gameevent.o tests/world_test.o world/generator.o world/world.o world/area.o util/timer.o util/filesystem.o util/geom.o world/tile.o world/area.o curseme/renderer.o util/noise.o game/containerbase.o game/containerbobject.o world/areabase.o world/descriptor.o world/tilebase.o world/worldbase.o world/clienttile.o world/clientarea.o world/clientworld.o game/observable.o util/uniquestringpair.o game/combat.o game/bobjectmanager.o game/complexbobject.o game/bobject.o game/atomicbobject.o game/compositebobject.o util/sectioneddata.o io/eventmeta.o $(CURSES_OBJS) $(RESOURCE_OBJS) $(BASIC_UTIL_OBJS) $(SAVE_OBJS)
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@
