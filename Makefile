...
raw_editor_ncurses: curseme/curseme.o curseme/curselog.o curseme/uistack.o curseme/window.o curseme/menu.o curseme/input.o util/log.o tools/raw_editor_ncurses/main.o resource/raw.o game/bobject.o game/complexbobject.o game/atomicbobject.o game/compositebobject.o util/filesystem.o tools/raw_editor_ncurses/common.o tools/raw_editor_ncurses/complex.o tools/raw_editor_ncurses/composite.o interface/choice.o interface/console.o util/packing.o game/bobjectmanager.o game/bobjectcontainer.o
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@
...
sockettest: tests/socket_test.o util/log.o net/netaddress.o net/socket.o net/tcpsocket.o net/listensocket.o net/serverprovider.o net/tcpbuffer.o net/connectionbuffer.o net/multiconnectionprovider.o net/packet.o util/timestamp.o curseme/curseme.o curseme/curselog.o curseme/window.o curseme/uistack.o
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@
